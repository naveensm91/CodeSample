...
defmodule CodeSampleIntegrationTest do
  ...
  test "We can add a comment to a file", context do
    assert CodeSample.create_comments("1234", CodeSample.Authentication.get_token, "Hello")
  end

  test "We can delete a comment from a file", context do
    assert CodeSample.delete_comments("32352311", CodeSample.Authentication.get_token)
  end

  test "We can modify a comment on a file", context do
    assert CodeSample.update_comments("32352311", CodeSample.Authentication.get_token, "Hello Again!")
  end
end
